...
KANAWHA county has greatest population, WIRT has smallest population, we can assume that the number of businesses is correlated with county population.
...
GREENBRIAR HOTEL CORPORATION, 8912202.0, Hospitality/Hotel, 500
```{r}
# Write the code to produce your answer here
wv_ppp_loans %>%
  arrange(desc(amount))
...
These numbers don't seem so newsworthy other than maybe the high total of the loans vs. the median amount, which is relatively low in comparison.
```{r}
# Write the code to produce your answer here
wv_summary <-
  wv_ppp_loans %>%
...
One thing I would consider is comparing the maximum loan amounts to the number of loans, as well as comparing total loan amounts to number of loans, the nature of the businesses with the highest mean loan amount, further reviewing th enumbers of jobs saved in relation to the loan amounts.
```{r}
# Write the code to produce your answer here
wv_county_summary <-
  wv_ppp_loans %>%
