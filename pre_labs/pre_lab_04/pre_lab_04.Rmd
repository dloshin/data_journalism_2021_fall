...
**Answer**
ZCTA5N is loaded in as a double. we need to convert to string
```{r}
...
**Answer**
Quick eyeballing, it looks like it. But I would have to scan the whole dataset to make sure.
```{r}
...
**Answer**
R	148	44328.87	19621	
U	43884	53868.53	20000	
...
**Answer**
R	18337	73694.14	20833	
U	95600	90911.14	20833	
```{r}
