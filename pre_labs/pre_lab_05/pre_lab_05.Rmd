...
**Answer**
Variations in spelling and formats of city name values
```{r}
...
Transformed (some) all-upper case names to a standard first letter upper case
I am not sure of the third, although in some cases it transfrmed a standard representation to the all upper case. Basically, it looks like what this function does is look for the came cahracter strings then standardize according to the version that appears most frequently.
```{r}
cleaned_md_loans %>%
