...
**Answer**
Tables listing NAICS sector codes.
...
**Answer**
The source HTML for the web page we looked at earlier.
...
**Answer**
A list of two HTML objects, a header and a body.
```{r}
# read in the html
...
**Answer**
It looks like a list of objects with an array of two objects, a head and a body.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
A separate window that shows the HTML elements that make up the SECTOR table.
### Task 9: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
```{r, echo=FALSE}
...
**Answer**
There are 6 objects that were read into the variable, each being a separate table.
```{r}
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
A list (?) of 6 objects, each being a list of lists, I think.
...
**Answer**
You see each dataframe loaded from the scraped web page.
### Task 14: Load image
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
A dataframe with the sector values and the sector names.
### Task 16: Load image
...
**Answer**
Just the dataframe for the sector table.
```{r}
...
**Answer**
A cleaned dataframe that has the last row removed 
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Workforce statistics for sector 22.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
The structure of what was read in as the HTML.
```{r}
...
**Answer**
A table containing the employment numbers for the specific period we were looking for.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
the sector stats for Mining, Oil & Gas (sector 21)
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
the sector stats for COnstruction (sector 23)
...
**Answer**
The strings printed out accordin hto the order of the individual statements.
```{r}
...
**Answer**
A list of the character strings.
```{r}
...
**Answer**
We get the same list of character strings printed out as before.
```{r}
...
**Answer**
error because we did not instantiate a variable called "sector_list".
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
The sector names are printed out
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
AN error message because we are not using "sector_name" as the loop variable, we are using x. sector_name is not assigned.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
The data in the naics_industry dataframe.
```{r}
...
**Answer**
the table with jun 2021 employment number for sector 21.
```{r}
...
**Answer**
A modified dataframe with a column holding the URL for the employment stats for each sector.
```{r}
...
**Answer**
A modified dataframe now with a column holding the sector xpath id.
```{r}
...
**Answer**
The dataframe with the row for Public Administration removed.
```{r}
...
**Answer**
The 19 dataframes extracted frm the big dataframe.
```{r}
...
**Answer**
The list of the URL/xpath combinations for all the data we want to scrape from the website.
```{r}
...
**Answer**
Dataframes for each of the NAICS sectors with the employment statistics scrpaed from the web site.
```{r}
...
**Answer**
The sector employment dataframes limited to the entries for employment seasonably adjusted.
```{r}
...
**Answer**
The 19 dataframes, each of which now containing acolumn for the sector number.
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
The 19 dataframes, each with the sector, description, and the June 2021 employment number.
```{r}
...
**Answer**
A single merged dataframe with information about employment statistics from all 19 sectors.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Workforce statis for Sector 21.
### Task 37: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
N EMployment numbers, just Unemployment percentages
### Task 39: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Answer**
A hack, but an NA placed in the slot for sector 11 June 2021 employees.
```{r}
