...
**Answer**
Records for vaccinations for which there is no associated county. Question: what is the meaning of the county field? I will go look in the web page to seee if there is a description. It does say: "Doses distributed and administered both account for the 16,000 doses of vaccine provided to the District of Columbia to vaccinate Maryland residents who work in DC"
...
**Answer**
Highest day is Friday, lower on Saturday and Sunday, wavers through the week, generally lower in rank among all the records.
```{r}
...
**Answer**
general trend is going down over time.
```{r fig.width=9}
ggplot() +
...
**Answer**
"The number of people in Prince George's County fully vaccinated on November 14 decreased by -74.25 percent compared to the week before"
```{r}
...
**Answer**
cumulative covid deaths over time by county
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
log scal eversion, although I dont think it is much clearer that the other scale
...
**Answer**
cumulative covid cases by county mapped along the color scale.
```{r}
ggplot() +
